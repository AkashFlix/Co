...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leech@ItsLeechBot")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "leechunzip@ItsLeechBot")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "leechzip@ItsLeechBot")
GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "gleech@ItsLeechBot")
GLEECH_UNZIP_COMMAND = os.environ.get("GLEECH_UNZIP_COMMAND", "gleechunzip@ItsLeechBot")
GLEECH_ZIP_COMMAND = os.environ.get("GLEECH_ZIP_COMMAND", "gleechzip@ItsLeechBot")
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl@ItsLeechBot")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "gytdl@ItsLeechBot")
RCLONE_CONFIG = os.environ.get("RCLONE_CONFIG", "")
DESTINATION_FOLDER = os.environ.get(
    "DESTINATION_FOLDER", "TorrentLeech-Gdrive")
INDEX_LINK = os.environ.get("INDEX_LINK", "")
TELEGRAM_LEECH_COMMAND = os.environ.get("TELEGRAM_LEECH_COMMAND", "tleech@ItsLeechBot")
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get(
    "TELEGRAM_LEECH_UNZIP_COMMAND", "tleechunzip@ItsLeechBot"
)
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel4@ItsLeechBot")
...
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumbnail@ItsLeechBot")
UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "False@ItsLeechBot")
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdl@ItsLeechBot")
GPYTDL_COMMAND = os.environ.get("GPYTDL_COMMAND", "gpytdl@ItsLeechBot")
LOG_COMMAND = os.environ.get("LOG_COMMAND", "log@ItsLeechBot")
CLONE_COMMAND_G = os.environ.get("CLONE_COMMAND_G", "gclone@ItsLeechBot")
UPLOAD_COMMAND = os.environ.get("UPLOAD_COMMAND", "upload@ItsLeechBot")
RENEWME_COMMAND = os.environ.get("RENEWME_COMMAND", "renewme@ItsLeechBot")
RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "rename@ItsLeechBot")
TOGGLE_VID = os.environ.get("TOGGLE_VID", "togglevid@ItsLeechBot")
TOGGLE_DOC = os.environ.get("TOGGLE_DOC", "toggledoc@ItsLeechBot")
RCLONE_COMMAND = os.environ.get("RCLONE_COMMAND", "rclone@ItsLeechBot")
HELP_COMMAND = os.environ.get("HELP_COMMAND", "help@ItsLeechBot")
