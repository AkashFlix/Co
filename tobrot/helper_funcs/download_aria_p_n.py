...
async def call_apropriate_function(
    ...
    if not is_file:
        ...
        if incoming_link.startswith("magnet:"):
            ...
            if err_message is not None:
                ...
                return False, "💠Can't Get METADATA #DeadTorrent⚰️"
        await asyncio.sleep(1)
        try:
    ...
    if is_unzip:
        try:
            ...
            LOGGER.info(ge)
            LOGGER.info(
                f"🗜️ 𝘾𝙖𝙣'𝙩 𝙚𝙭𝙩𝙧𝙖𝙘𝙩 {os.path.basename(to_upload_file)}, Uploading The Same File 🔺"
            )
        ...
        if is_cloud:
            ...
            try:
                ...
                if message_to_send != "":
                    ...
                    message_to_send = "🚫 Failed To Upload"
