...
async def incoming_message_f(client, message):
    ...
    if rep_mess:
        if not rep_mess.media or rep_mess.document.file_name.lower().endswith(".torrent"):
            ...
            if user_command == LEECH_COMMAND.lower():
                await i_m_sefg.edit("⚠️𝙉𝙤 𝙙𝙤𝙬𝙣𝙡𝙤𝙖𝙙𝙞𝙣𝙜 𝙨𝙤𝙪𝙧𝙘𝙚 𝙥𝙧𝙤𝙫𝙞𝙙𝙚𝙙⚠️")
                return
            is_file = True
            dl_url = rep_mess
    ...
    if dl_url is not None:
        ...
        await i_m_sefg.edit_text("𝘼𝙙𝙙𝙚𝙙 𝙏𝙤 𝙙𝙤𝙬𝙣𝙡𝙤𝙖𝙙𝙨 𝙨𝙚𝙣𝙙 /status 𝙛𝙤𝙧 𝙈𝙤𝙧𝙚")
        ...
        await i_m_sefg.edit_text(
            "**ERROR**! wat have you entered. watch what you type \n"
...
async def rename_tg_file(client, message):
    ...
    if not message.reply_to_message:
        await message.reply("⚠️𝙉𝙤 𝙙𝙤𝙬𝙣𝙡𝙤𝙖𝙙𝙞𝙣𝙜 𝙨𝙤𝙪𝙧𝙘𝙚 𝙥𝙧𝙤𝙫𝙞𝙙𝙚𝙙⚠️", quote=True)
        return
