    ...
    while True:
        ...
        for file in downloads:
            ...
            if file.status == "active":
                ...
                msg += f"\n<b>├</b> <b>{prog}</b>"
                msg += f"\n<b>│</b>"
                msg += f"\n<b>├ 📂 𝚃𝚘𝚝𝚊𝚕 𝚂𝚒𝚣𝚎: {file.total_length_string()}</b>"
                msg += f"\n<b>│</b>"
                msg += f"\n<b>├ 📡 𝙿𝚛𝚘𝚐𝚛𝚎𝚜𝚜: {file.progress_string()}</b>"
                msg += f"\n<b>│</b>"
                msg += f"\n<b>├ ⏳ 𝙴𝚃𝙰: {file.eta_string()}</b>"
                msg += f"\n<b>│</b>"
                msg += f"\n<b>├ ⚡️ 𝚂𝚙𝚎𝚎𝚍: {file.download_speed_string()}</b>" 
                msg += f"\n<b>│</b>"
                msg += f"\n<b>├ {msgg}</b>"
                msg += f"\n<b>│</b>"
